...
var $author$project$Main$kingyoCaught = _Platform_incomingPort(
	'kingyoCaught',
	A2(
...
var $author$project$Main$kingyoInfo = _Platform_incomingPort(
	'kingyoInfo',
	$elm$json$Json$Decode$list(
		A2(
			$elm$json$Json$Decode$andThen,
...
var $author$project$Main$skywayId = _Platform_incomingPort(
	'skywayId',
	A2(
		$elm$json$Json$Decode$andThen,
		function (num) {
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Main$kingyoInfo($author$project$Types$KingyoMoved),
				$author$project$Main$kingyoCaught($author$project$Types$KingyoCaught),
...
var $author$project$Main$caught = _Platform_outgoingPort(
	'caught',
	function ($) {
...
var $author$project$Main$kingyoStep = function (kingyo) {
	var newVy = ((_Utils_cmp(kingyo.pos.y + kingyo.v.y, $author$project$Main$pondHeight) > 0) || ((kingyo.pos.y + kingyo.v.y) < 0)) ? (-kingyo.v.y) : kingyo.v.y;
	var newVx = ((_Utils_cmp(kingyo.pos.x + kingyo.v.x, $author$project$Main$pondWidth) > 0) || ((kingyo.pos.x + kingyo.v.x) < 0)) ? (-kingyo.v.x) : kingyo.v.x;
...
var $author$project$Main$sukuu = F2(
		...
		switch (msg.$) {
			...
			case 'Tick':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							kingyos: A2($elm$core$List$map, $author$project$Main$kingyoStep, model.kingyos)
						}),
					model.host ? $author$project$Main$sendKingyo(model.kingyos) : $elm$core$Platform$Cmd$none);
			case 'Join':
				return _Utils_Tuple2(
					model,
			...
			case 'KingyoCaught':
				...
				return model.host ? _Utils_Tuple2(
					...
					$author$project$Main$sendKingyo(data.kingyos)) : _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$kingyoView = function (kingyo) {
	var vy = kingyo.v.y;
	var vx = kingyo.v.x;
